...
in
  linkFarm name [
    {
      name = "aro-0.0.0-JSD1QqwsOQDAh_e8bJS3ITkoIMaN-Bci_6EI6EFxieo5";
      path = fetchZigArtifact {
        name = "aro";
        url = "https://github.com/kitknox/arocc-rootshell/archive/596aee91a5083e6aba9a0e9c95762d1ce2725aac.tar.gz";
        hash = "sha256-rYNtAsPjVRv3USlqMdqX2E7z6quIcCFavOL59bx1DIA=";
        unpack = true;
      };
    }
    {
    ...
    {
      name = "libxev-0.0.0-86vtc_H_EwALyMPlcg0OqQftacnG4eZKc29w-rMk2byG";
      path = fetchZigArtifact {
        name = "libxev";
        url = "https://github.com/kitknox/libxev-rootshell/archive/9441029fbdcce85e28024d30a8737137152958f0.tar.gz";
        hash = "sha256-YMGGbjbfkOtjZONiM4JNkWJUJZF+sm6Grt99JrJLbpM=";
        unpack = true;
      };
    }
    {
    ...
    {
      name = "translate_c-0.0.0-Q_BUWuA_BwB_CVrwdE9W26b9-Km_dvLKuNXnZv7ps0CY";
      path = fetchZigArtifact {
        name = "translate_c";
        url = "https://github.com/kitknox/translate-c-rootshell/archive/cb0e8f8068ae1927c781707c7f5f52310f0972e5.tar.gz";
        hash = "sha256-xBaHOzKTs7oNRe8DCG6uj1lSHFNFAcdP7XUlER0j4Q8=";
        unpack = true;
      };
    }
    {

        ...
        switch (message) {
            ...
            .visible => |v| {
                ...
                if (v) {
                    ...
                    // renderCallback does updateFrame + drawFrame(false) and also
                    // reschedules any Kitty graphics animation wakeup that lapsed
                    // while we were invisible. flags.visible is already true here,
